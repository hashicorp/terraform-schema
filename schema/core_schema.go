...
import (
	...
	mod_v1_17 "github.com/hashicorp/terraform-schema/internal/schema/1.17"
...
var (
	...
	v1_17 = version.Must(version.NewVersion("1.17.0-alpha20260729"))
)
...
func CoreModuleSchemaForVersion(v *version.Version) (*schema.BodySchema, error) {
	ver := v.Core()
	if ver.GreaterThanOrEqual(v1_17) {
		return mod_v1_17.ModuleSchema(ver), nil
	}
