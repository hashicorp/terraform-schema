...
func main() {
	...
	writeFunctions(functionsFile, functions)
	...
	writeFunctionVersions("functions.go", versions)
}
...
func writeFunctions(filename string, functions *tfjson.MetadataFunctions) {
...
func writeFunctionVersions(filename string, versions []*version.Version) {
	outputTpl := `// Code generated by "gen"; DO NOT EDIT.
package funcs
